<script>
	...
	function load_consumption_graph(year,vaccine) {
		...
		var url = '<?php echo base_url()."consumption_management/getRegionConsumption/"?>'+year+'/' + vaccine; 
	...
	function load_coverage_graph(vaccine) {
		...
		var url = '<?php echo base_url()."coverage_management/getRegionCoverage/"?>' + vaccine; 
		chart.setDataURL(url);
		chart.render(graph_id);
