<script>
	$(function() {
		...
		var url = '<?php echo base_url()."months_of_stock/get_mos_balance/0/".$this -> session -> userdata('district_province_id')."/0"?>'; 
		...
		var url = '<?php echo base_url()."cold_chain/get_utilization/0/".$this -> session -> userdata('district_province_id')."/0"?>'; 
		chart.setDataURL(url);
		...
		var url = '<?php echo base_url()."cold_chain/get_fridge_occupancy/0/".$this -> session -> userdata('district_province_id')."/0"?>'; 
		chart.setDataURL(url);
		...
		var url = '<?php echo base_url()."cold_chain/get_freezer_occupancy/0/".$this -> session -> userdata('district_province_id')."/0"?>'; 
		chart.setDataURL(url);
		...
		var url = '<?php echo base_url()."mos_trend/get/0/0/0/".$this -> session -> userdata('district_province_id')."/0"?>'; 
		chart.setDataURL(url);
		...
		$("#refresh_mos_trend_graph").click(function(){
			var vaccine_string = "";
				...
				var data_url = '<?php echo base_url();?>mos_trend/download_mos_trend/'+selected_year+'/0/<?php echo $this -> session -> userdata('district_province_id')."/0"?>'; 
				$("#trend_data_download").attr("href",data_url);
				$("#mos_trend_larger_graph_container").dialog('option', 'title', 'Antigen MOS Balance Trend');
				$("#mos_trend_larger_graph_container").dialog("open");
				var chart = new FusionCharts("<?php echo base_url()."Scripts/FusionCharts/Charts/MSLine.swf"?>", "ChartId", "900", "450", "0", "0");	
				var url = '<?php echo base_url();?>mos_trend/get/'+vaccine_string+'/'+selected_year+'/0/<?php echo $this -> session -> userdata('district_province_id')."/0"?>'; 
				chart.setDataURL(url);
				chart.render("mos_trend_larger_graph");
		});
...
<div class="larger_graph">
	<a class="link view_larger_graph" href="#" id="mos_graph">Enlarge</a> | <a class="link" href="<?php echo base_url().'months_of_stock/download/0/'.$this -> session -> userdata('district_province_id').'/0';?>">Download Data</a>
</div>
...
<div class="larger_graph">
	<a class="link view_larger_graph" id="cold_chain_graph">Enlarge</a> | <a class="link" href="<?php echo base_url().'cold_chain/download/0/'.$this -> session -> userdata('district_province_id').'/0';?>">Download Data</a>
</div>
...
<div class="larger_graph">
<a class="link" href="<?php echo base_url().'cold_chain/download/0/'.$this -> session -> userdata('district_province_id').'/0';?>">Download Data</a>
</div>
...
<div class="larger_graph" style="margin-top: -20px;">
	<a class="link view_larger_graph" id="mos_trend_graph">View More</a> | <a class="link" href="<?php echo base_url().'mos_trend/download_mos_trend/0/0/'.$this -> session -> userdata('district_province_id').'/0';?>">Download Data</a>
</div>
...
<div id="mos_trend_filter">
	...
	<a class="link" id="trend_data_download" href="<?php echo base_url().'mos_trend/download_mos_trend/0/0/'.$this -> session -> userdata('district_province_id').'/0';?>">Download Data</a>
</div>
