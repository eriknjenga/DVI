...
class Disbursements extends Doctrine_Record {
	...
	public static function getNationalDisbursements($vaccine, $from, $to, $offset, $items, $district_store = 0, $regional_store = 0, $order_by, $order, $balance = 0) {
		...
		if ($district_store > 0) {
			if ($order == "DESC") {
				$query -> addComponent('d', 'Disbursements') -> select('{d.Date_Issued},{d.Issued_To_National},{d.Issued_To_Region},{d.Issued_To_District},{d.Quantity},{d.Vaccine_Id},{d.Batch_Number},{d.Voucher_Number},{d.Added_By},{d.Stock_At_Hand},{d.Total_Stock_In},{d.Total_Stock_Out},{d.Total_Stock_Balance}') -> from("(SELECT id,Date_Issued,Issued_To_National,Issued_To_Region,Issued_To_District,Quantity,Vaccine_Id,Batch_Number,Voucher_Number,Added_By,Stock_At_Hand, (case when Issued_By_National='0' then (@stock_out := @stock_out - Quantity) end) as total_stock_out, (case when Issued_To_National='0' then (@stock_in := @stock_in - Quantity) end) as total_stock_in, (@stock_balance := @stock_in - @stock_out) as total_stock_balance FROM Disbursements d where (Issued_By_National = '0' or Issued_To_National = '0')  and Vaccine_Id = '$vaccine' and Issued_To_District = '$district_store' and Date_Issued_Timestamp between '$from' and '$to' and Owner = '$owner' order by $order_by $order) d") -> offset($offset) -> limit($items);
			} else {
				$query -> addComponent('d', 'Disbursements') -> select('{d.Date_Issued},{d.Issued_To_National},{d.Issued_To_Region},{d.Issued_To_District},{d.Quantity},{d.Vaccine_Id},{d.Batch_Number},{d.Voucher_Number},{d.Added_By},{d.Stock_At_Hand},{d.Total_Stock_In},{d.Total_Stock_Out},{d.Total_Stock_Balance}') -> from("(SELECT id,Date_Issued,Issued_To_National,Issued_To_Region,Issued_To_District,Quantity,Vaccine_Id,Batch_Number,Voucher_Number,Added_By,Stock_At_Hand, (case when Issued_By_National='0' then (@stock_out := @stock_out + Quantity) end) as total_stock_out, (case when Issued_To_National='0' then (@stock_in := @stock_in + Quantity) end) as total_stock_in, (@stock_balance := @stock_in - @stock_out) as total_stock_balance FROM Disbursements d where (Issued_By_National = '0' or Issued_To_National = '0')  and Vaccine_Id = '$vaccine' and Issued_To_District = '$district_store' and Date_Issued_Timestamp between '$from' and '$to' and Owner = '$owner' order by $order_by $order) d") -> offset($offset) -> limit($items);
			}
		} else if ($regional_store > 0) {
			if ($order == "DESC") {
				$query -> addComponent('d', 'Disbursements') -> select('{d.Date_Issued},{d.Issued_To_National},{d.Issued_To_Region},{d.Issued_To_District},{d.Quantity},{d.Vaccine_Id},{d.Batch_Number},{d.Voucher_Number},{d.Added_By},{d.Stock_At_Hand},{d.Total_Stock_In},{d.Total_Stock_Out},{d.Total_Stock_Balance}') -> from("(SELECT id,Date_Issued,Issued_To_National,Issued_To_Region,Issued_To_District,Quantity,Vaccine_Id,Batch_Number,Voucher_Number,Added_By,Stock_At_Hand, (case when Issued_By_National='0' then (@stock_out := @stock_out - Quantity) end) as total_stock_out, (case when Issued_To_National='0' then (@stock_in := @stock_in - Quantity) end) as total_stock_in, (@stock_balance := @stock_in - @stock_out) as total_stock_balance FROM Disbursements d where (Issued_By_National = '0' or Issued_To_National = '0')  and Vaccine_Id = '$vaccine' and Issued_To_Region = '$regional_store' and Date_Issued_Timestamp between '$from' and '$to' and Owner = '$owner' order by $order_by $order) d") -> offset($offset) -> limit($items);
			} else {
				$query -> addComponent('d', 'Disbursements') -> select('{d.Date_Issued},{d.Issued_To_National},{d.Issued_To_Region},{d.Issued_To_District},{d.Quantity},{d.Vaccine_Id},{d.Batch_Number},{d.Voucher_Number},{d.Added_By},{d.Stock_At_Hand},{d.Total_Stock_In},{d.Total_Stock_Out},{d.Total_Stock_Balance}') -> from("(SELECT id,Date_Issued,Issued_To_National,Issued_To_Region,Issued_To_District,Quantity,Vaccine_Id,Batch_Number,Voucher_Number,Added_By,Stock_At_Hand, (case when Issued_By_National='0' then (@stock_out := @stock_out + Quantity) end) as total_stock_out, (case when Issued_To_National='0' then (@stock_in := @stock_in + Quantity) end) as total_stock_in, (@stock_balance := @stock_in - @stock_out) as total_stock_balance FROM Disbursements d where (Issued_By_National = '0' or Issued_To_National = '0')  and Vaccine_Id = '$vaccine' and Issued_To_Region = '$regional_store' and Date_Issued_Timestamp between '$from' and '$to' and Owner = '$owner' order by $order_by $order) d") -> offset($offset) -> limit($items);
			}
		} else {
			...
			if ($order == "DESC") {
				$query -> addComponent('d', 'Disbursements') -> select('{d.Date_Issued},{d.Issued_To_National},{d.Issued_To_Region},{d.Issued_To_District},{d.Quantity},{d.Vaccine_Id},{d.Batch_Number},{d.Voucher_Number},{d.Added_By},{d.Stock_At_Hand},{d.Total_Stock_In},{d.Total_Stock_Out},{d.Total_Stock_Balance}') -> from("(SELECT id,Date_Issued,Issued_To_National,Issued_To_Region,Issued_To_District,Quantity,Vaccine_Id,Batch_Number,Voucher_Number,Added_By,Stock_At_Hand, (case when Issued_By_National='0' then (@stock_out := @stock_out - Quantity) end) as total_stock_out, (case when Issued_To_National='0' then (@stock_in := @stock_in - Quantity) end) as total_stock_in, (@stock_balance := @stock_in - @stock_out) as total_stock_balance FROM Disbursements d where (Issued_By_National = '0' or Issued_To_National = '0')  and Vaccine_Id = '$vaccine' and Date_Issued_Timestamp between '$from' and '$to' and Owner = '$owner' order by $order_by $order) d") -> offset($offset) -> limit($items);
			} else {
				$query -> addComponent('d', 'Disbursements') -> select('{d.Date_Issued},{d.Issued_To_National},{d.Issued_To_Region},{d.Issued_To_District},{d.Quantity},{d.Vaccine_Id},{d.Batch_Number},{d.Voucher_Number},{d.Added_By},{d.Stock_At_Hand},{d.Total_Stock_In},{d.Total_Stock_Out},{d.Total_Stock_Balance}') -> from("(SELECT id,Date_Issued,Issued_To_National,Issued_To_Region,Issued_To_District,Quantity,Vaccine_Id,Batch_Number,Voucher_Number,Added_By,Stock_At_Hand, (case when Issued_By_National='0' then (@stock_out := @stock_out + Quantity) end) as total_stock_out, (case when Issued_To_National='0' then (@stock_in := @stock_in + Quantity) end) as total_stock_in, (@stock_balance := @stock_in - @stock_out) as total_stock_balance FROM Disbursements d where (Issued_By_National = '0' or Issued_To_National = '0')  and Vaccine_Id = '$vaccine' and Date_Issued_Timestamp between '$from' and '$to' and Owner = '$owner' order by $order_by $order) d") -> offset($offset) -> limit($items);
			}
		}
	...
	public static function getTotalNationalDisbursements($vaccine, $from, $to, $district_store, $regional_store) {
		$owner = "N0";
		if ($district_store > 0) {
			$query = Doctrine_Query::create() -> select("COUNT(*) as Total_Disbursements") -> from("Disbursements") -> where("(Issued_By_National = '0' or Issued_To_National = '0') and Issued_To_District = '$district_store' and Vaccine_Id = '$vaccine' and Date_Issued_Timestamp between '$from' and '$to' and Owner = '$owner'") -> orderBy("Date_Issued_Timestamp desc");
		} elseif ($regional_store > 0) {
			$query = Doctrine_Query::create() -> select("COUNT(*) as Total_Disbursements") -> from("Disbursements") -> where("(Issued_By_National = '0' or Issued_To_National = '0') and Issued_To_Region = '$regional_store' and Vaccine_Id = '$vaccine' and Date_Issued_Timestamp between '$from' and '$to' and Owner = '$owner'") -> orderBy("Date_Issued_Timestamp desc");
		} else {
			$query = Doctrine_Query::create() -> select("COUNT(*) as Total_Disbursements") -> from("Disbursements") -> where("(Issued_By_National = '0' or Issued_To_National = '0') and Vaccine_Id = '$vaccine' and Date_Issued_Timestamp between '$from' and '$to' and Owner = '$owner'") -> orderBy("Date_Issued_Timestamp desc");
		}
	...
	public static function getTotalRegionalDisbursements($region, $vaccine, $from, $to, $district_store, $regional_store) {
		$owner = "R" . $region;
		if ($district_store > 0) {
			$query = Doctrine_Query::create() -> select("COUNT(*) as Total_Disbursements") -> from("Disbursements") -> where("(Issued_By_Region = '$region' or Issued_To_Region = '$region') and Issued_To_District = '$district_store' and Vaccine_Id = '$vaccine' and Date_Issued_Timestamp between '$from' and '$to' and Owner = '$owner'") -> orderBy("Date_Issued_Timestamp desc");
		} elseif ($regional_store > 0) {
			$query = Doctrine_Query::create() -> select("COUNT(*) as Total_Disbursements") -> from("Disbursements") -> where("(Issued_By_Region = '$region' or Issued_To_Region = '$region') and Issued_To_Region = '$regional_store' and Vaccine_Id = '$vaccine' and Date_Issued_Timestamp between '$from' and '$to' and Owner = '$owner'") -> orderBy("Date_Issued_Timestamp desc");
		} else {
			$query = Doctrine_Query::create() -> select("COUNT(*) as Total_Disbursements") -> from("Disbursements") -> where("(Issued_By_Region = '$region' or Issued_To_Region = '$region') and Vaccine_Id = '$vaccine' and Date_Issued_Timestamp between '$from' and '$to' and Owner = '$owner'") -> orderBy("Date_Issued_Timestamp desc");
		}
	...
	public static function getTotalDistrictDisbursements($district, $vaccine, $from, $to, $district_store) {
		$owner = "D" . $district;
		if ($district_store > 0) {
			$query = Doctrine_Query::create() -> select("COUNT(*) as Total_Disbursements") -> from("Disbursements") -> where("(Issued_By_District = '$district' or Issued_To_District = '$district') and Issued_To_District = '$district_store' and Vaccine_Id = '$vaccine' and Date_Issued_Timestamp between '$from' and '$to' and Owner = '$owner'") -> orderBy("Date_Issued_Timestamp desc");
		} else {
			$query = Doctrine_Query::create() -> select("COUNT(*) as Total_Disbursements") -> from("Disbursements") -> where("(Issued_By_District = '$district' or Issued_To_District = '$district') and Vaccine_Id = '$vaccine' and Date_Issued_Timestamp between '$from' and '$to' and Owner = '$owner'") -> orderBy("Date_Issued_Timestamp desc");
		}
		$count = $query -> execute();
		return $count[0] -> Total_Disbursements;
	}
	...
	public static function getRegionalDisbursements($region, $vaccine, $from, $to, $offset, $items, $district_store = 0, $regional_store = 0, $order_by, $order, $balance = 0) {
		...
		if ($district_store > 0) {
			if ($order == "DESC") {
				$query -> addComponent('d', 'Disbursements') -> select('{d.Date_Issued},{d.Issued_To_National},{d.Issued_To_Region},{d.Issued_To_District},{d.Quantity},{d.Vaccine_Id},{d.Batch_Number},{d.Voucher_Number},{d.Added_By},{d.Stock_At_Hand},{d.Total_Stock_In},{d.Total_Stock_Out},{d.Total_Stock_Balance}') -> from("(SELECT id,Date_Issued,Issued_To_National,Issued_To_Region,Issued_To_District,Quantity,Vaccine_Id,Batch_Number,Voucher_Number,Added_By,Stock_At_Hand, (case when Issued_By_Region='$region' then (@stock_out := @stock_out - Quantity) end) as total_stock_out, (case when Issued_To_Region='$region'  then (@stock_in := @stock_in - Quantity) end) as total_stock_in, (@stock_balance := @stock_in - @stock_out) as total_stock_balance FROM Disbursements d where (Issued_By_Region = '$region' or Issued_To_Region = '$region')  and Vaccine_Id = '$vaccine' and Issued_To_District = '$district_store' and Date_Issued_Timestamp between '$from' and '$to' and Owner = '$owner' order by $order_by $order) d") -> offset($offset) -> limit($items);
			} else {
				$query -> addComponent('d', 'Disbursements') -> select('{d.Date_Issued},{d.Issued_To_National},{d.Issued_To_Region},{d.Issued_To_District},{d.Quantity},{d.Vaccine_Id},{d.Batch_Number},{d.Voucher_Number},{d.Added_By},{d.Stock_At_Hand},{d.Total_Stock_In},{d.Total_Stock_Out},{d.Total_Stock_Balance}') -> from("(SELECT id,Date_Issued,Issued_To_National,Issued_To_Region,Issued_To_District,Quantity,Vaccine_Id,Batch_Number,Voucher_Number,Added_By,Stock_At_Hand, (case when Issued_By_Region='$region' then (@stock_out := @stock_out + Quantity) end) as total_stock_out, (case when Issued_To_Region='$region'  then (@stock_in := @stock_in + Quantity) end) as total_stock_in, (@stock_balance := @stock_in - @stock_out) as total_stock_balance FROM Disbursements d where (Issued_By_Region = '$region' or Issued_To_Region = '$region')  and Vaccine_Id = '$vaccine' and Issued_To_District = '$district_store' and Date_Issued_Timestamp between '$from' and '$to' and Owner = '$owner' order by $order_by $order) d") -> offset($offset) -> limit($items);
			}
		} else if ($regional_store > 0) {
			if ($order == "DESC") {
				$query -> addComponent('d', 'Disbursements') -> select('{d.Date_Issued},{d.Issued_To_National},{d.Issued_To_Region},{d.Issued_To_District},{d.Quantity},{d.Vaccine_Id},{d.Batch_Number},{d.Voucher_Number},{d.Added_By},{d.Stock_At_Hand},{d.Total_Stock_In},{d.Total_Stock_Out},{d.Total_Stock_Balance}') -> from("(SELECT id,Date_Issued,Issued_To_National,Issued_To_Region,Issued_To_District,Quantity,Vaccine_Id,Batch_Number,Voucher_Number,Added_By,Stock_At_Hand, (case when Issued_By_Region='$region' then (@stock_out := @stock_out - Quantity) end) as total_stock_out, (case when Issued_To_Region='$region' then (@stock_in := @stock_in - Quantity) end) as total_stock_in, (@stock_balance := @stock_in - @stock_out) as total_stock_balance FROM Disbursements d where (Issued_By_Region = '$region' or Issued_To_Region = '$region')  and Vaccine_Id = '$vaccine' and Issued_To_Region = '$regional_store' and Date_Issued_Timestamp between '$from' and '$to' and Owner = '$owner' order by $order_by $order) d") -> offset($offset) -> limit($items);
			} else {
				$query -> addComponent('d', 'Disbursements') -> select('{d.Date_Issued},{d.Issued_To_National},{d.Issued_To_Region},{d.Issued_To_District},{d.Quantity},{d.Vaccine_Id},{d.Batch_Number},{d.Voucher_Number},{d.Added_By},{d.Stock_At_Hand},{d.Total_Stock_In},{d.Total_Stock_Out},{d.Total_Stock_Balance}') -> from("(SELECT id,Date_Issued,Issued_To_National,Issued_To_Region,Issued_To_District,Quantity,Vaccine_Id,Batch_Number,Voucher_Number,Added_By,Stock_At_Hand, (case when Issued_By_Region='$region' then (@stock_out := @stock_out + Quantity) end) as total_stock_out, (case when Issued_To_Region='$region' then (@stock_in := @stock_in + Quantity) end) as total_stock_in, (@stock_balance := @stock_in - @stock_out) as total_stock_balance FROM Disbursements d where (Issued_By_Region = '$region' or Issued_To_Region = '$region')  and Vaccine_Id = '$vaccine' and Issued_To_Region = '$regional_store' and Date_Issued_Timestamp between '$from' and '$to' and Owner = '$owner' order by $order_by $order) d") -> offset($offset) -> limit($items);
			}
		} else {
			...
			if ($order == "DESC") {
				...
				//$query -> addComponent('d', 'Disbursements') -> select('{d.Date_Issued},{d.Issued_To_National},{d.Issued_To_Region},{d.Issued_To_District},{d.Quantity},{d.Vaccine_Id},{d.Batch_Number},{d.Voucher_Number},{d.Added_By},{d.Stock_At_Hand},{d.Total_Stock_In},{d.Total_Stock_Out},{d.Total_Stock_Balance}') -> from("(SELECT id,Date_Issued,Issued_To_National,Issued_To_Region,Issued_To_District,Quantity,Vaccine_Id,Batch_Number,Voucher_Number,Added_By,Stock_At_Hand, (case when Issued_By_Region='$region' then (@stock_out := @stock_out + Quantity) end) as total_stock_out, (case when Issued_To_Region='$region' then (@stock_in := @stock_in + Quantity) end) as total_stock_in, (@stock_balance := @stock_in - @stock_out) as total_stock_balance FROM Disbursements d where (Issued_By_Region = '$region' or Issued_To_Region = '$region')  and Vaccine_Id = '$vaccine' and Date_Issued_Timestamp between '$from' and '$to' and Owner = '$owner' order by $order_by $order) d") -> offset($offset) -> limit($items);
	...
	public static function getDistrictDisbursements($district, $vaccine, $from, $to, $offset, $items, $order_by, $order, $district_store = 0, $balance = 0) {
		...
		if ($district_store > 0) {
			if ($order == "DESC") {
				$query -> addComponent('d', 'Disbursements') -> select('{d.Date_Issued},{d.Issued_To_National},{d.Issued_To_Region},{d.Issued_To_District},{d.Quantity},{d.Vaccine_Id},{d.Batch_Number},{d.Voucher_Number},{d.Added_By},{d.Stock_At_Hand},{d.Total_Stock_In},{d.Total_Stock_Out},{d.Total_Stock_Balance}') -> from("(SELECT id,Date_Issued,Issued_To_National,Issued_To_Region,Issued_To_District,Quantity,Vaccine_Id,Batch_Number,Voucher_Number,Added_By,Stock_At_Hand, (case when Issued_By_District='$district' then (@stock_out := @stock_out - Quantity) end) as total_stock_out, (case when Issued_To_District='$district' then (@stock_in := @stock_in - Quantity) end) as total_stock_in, (@stock_balance := @stock_in - @stock_out) as total_stock_balance FROM Disbursements d where (Issued_By_District = '$district' or Issued_To_District = '$district')  and Vaccine_Id = '$vaccine' and Issued_To_District = '$district_store' and Date_Issued_Timestamp between '$from' and '$to' and Owner = '$owner' order by $order_by $order) d") -> offset($offset) -> limit($items);
			} else {
				$query -> addComponent('d', 'Disbursements') -> select('{d.Date_Issued},{d.Issued_To_National},{d.Issued_To_Region},{d.Issued_To_District},{d.Quantity},{d.Vaccine_Id},{d.Batch_Number},{d.Voucher_Number},{d.Added_By},{d.Stock_At_Hand},{d.Total_Stock_In},{d.Total_Stock_Out},{d.Total_Stock_Balance}') -> from("(SELECT id,Date_Issued,Issued_To_National,Issued_To_Region,Issued_To_District,Quantity,Vaccine_Id,Batch_Number,Voucher_Number,Added_By,Stock_At_Hand, (case when Issued_By_District='$district' then (@stock_out := @stock_out + Quantity) end) as total_stock_out, (case when Issued_To_District='$district' then (@stock_in := @stock_in + Quantity) end) as total_stock_in, (@stock_balance := @stock_in - @stock_out) as total_stock_balance FROM Disbursements d where (Issued_By_District = '$district' or Issued_To_District = '$district')  and Vaccine_Id = '$vaccine' and Issued_To_District = '$district_store' and Date_Issued_Timestamp between '$from' and '$to' and Owner = '$owner' order by $order_by $order) d") -> offset($offset) -> limit($items);
			}
		} else {
			...
			if ($order == "DESC") {
				$query -> addComponent('d', 'Disbursements') -> select('{d.Date_Issued},{d.Issued_To_National},{d.Issued_To_Region},{d.Issued_To_District},{d.Quantity},{d.Vaccine_Id},{d.Batch_Number},{d.Voucher_Number},{d.Added_By},{d.Stock_At_Hand},{d.Total_Stock_In},{d.Total_Stock_Out},{d.Total_Stock_Balance}') -> from("(SELECT id,Date_Issued,Issued_To_National,Issued_To_Region,Issued_To_District,Quantity,Vaccine_Id,Batch_Number,Voucher_Number,Added_By,Stock_At_Hand, (case when Issued_By_District='$district' then (@stock_out := @stock_out - Quantity) end) as total_stock_out, (case when Issued_To_District='$district' then (@stock_in := @stock_in - Quantity) end) as total_stock_in, (@stock_balance := @stock_in - @stock_out) as total_stock_balance FROM Disbursements d where (Issued_By_District = '$district' or Issued_To_District = '$district')  and Vaccine_Id = '$vaccine' and Date_Issued_Timestamp between '$from' and '$to' and Owner = '$owner' order by $order_by $order) d") -> offset($offset) -> limit($items);
			} else {
				$query -> addComponent('d', 'Disbursements') -> select('{d.Date_Issued},{d.Issued_To_National},{d.Issued_To_Region},{d.Issued_To_District},{d.Quantity},{d.Vaccine_Id},{d.Batch_Number},{d.Voucher_Number},{d.Added_By},{d.Stock_At_Hand},{d.Total_Stock_In},{d.Total_Stock_Out},{d.Total_Stock_Balance}') -> from("(SELECT id,Date_Issued,Issued_To_National,Issued_To_Region,Issued_To_District,Quantity,Vaccine_Id,Batch_Number,Voucher_Number,Added_By,Stock_At_Hand, (case when Issued_By_District='$district' then (@stock_out := @stock_out + Quantity) end) as total_stock_out, (case when Issued_To_District='$district' then (@stock_in := @stock_in + Quantity) end) as total_stock_in, (@stock_balance := @stock_in - @stock_out) as total_stock_balance FROM Disbursements d where (Issued_By_District = '$district' or Issued_To_District = '$district')  and Vaccine_Id = '$vaccine' and Date_Issued_Timestamp between '$from' and '$to' and Owner = '$owner' order by $order_by $order) d") -> offset($offset) -> limit($items);
			}
		}
	...
	public static function getNationalPeriodBalance($vaccine, $from) {
		$owner = "N0";
		$query = Doctrine_Query::create() -> select("SUM(Quantity) as Totals") -> from("Disbursements") -> where("Issued_By_National = '0' and Vaccine_Id = '$vaccine' and Date_Issued_Timestamp < '$from' and Owner = '$owner'");
		$issued = $query -> execute(array(), Doctrine::HYDRATE_ARRAY);
		$query2 = Doctrine_Query::create() -> select("SUM(Quantity) as Totals") -> from("Disbursements") -> where("Issued_To_National = '0' and Vaccine_Id = '$vaccine' and Date_Issued_Timestamp < '$from' and Owner = '$owner'");
