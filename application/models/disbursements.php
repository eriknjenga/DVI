...
class Disbursements extends Doctrine_Record {
	...
	public static function getNationalDisbursements($vaccine, $from, $to, $offset, $items, $district_store = 0, $regional_store = 0, $order_by, $order, $balance = 0) {
		...
		if ($district_store > 0) {
			...
			if ($order == "DESC") {
				$query -> addComponent('d', 'Disbursements') -> select('{d.Date_Issued},{d.Issued_To_National},{d.Issued_To_Region},{d.Issued_To_District},{d.Quantity},{d.Vaccine_Id},{d.Batch_Number},{d.Voucher_Number},{d.Added_By},{d.Stock_At_Hand},{d.Total_Stock_In},{d.Total_Stock_Out},{d.Total_Stock_Balance}') -> from("(SELECT id,Date_Issued,Issued_To_National,Issued_To_Region,Issued_To_District,Quantity,Vaccine_Id,Batch_Number,Voucher_Number,Added_By,Stock_At_Hand, (case when Issued_By_National='0' then (@stock_out := @stock_out - Quantity) end) as total_stock_out, (case when Issued_To_National='0' then (@stock_in := @stock_in - Quantity) end) as total_stock_in, (@stock_balance := @stock_in - @stock_out) as total_stock_balance FROM Disbursements d where (Issued_By_National = '0' or Issued_To_National = '0')  and Vaccine_Id = '$vaccine' and Date_Issued_Timestamp between '$from' and '$to' order by $order_by $order) d") -> offset($offset) -> limit($items);
			} else {
				$query -> addComponent('d', 'Disbursements') -> select('{d.Date_Issued},{d.Issued_To_National},{d.Issued_To_Region},{d.Issued_To_District},{d.Quantity},{d.Vaccine_Id},{d.Batch_Number},{d.Voucher_Number},{d.Added_By},{d.Stock_At_Hand},{d.Total_Stock_In},{d.Total_Stock_Out},{d.Total_Stock_Balance}') -> from("(SELECT id,Date_Issued,Issued_To_National,Issued_To_Region,Issued_To_District,Quantity,Vaccine_Id,Batch_Number,Voucher_Number,Added_By,Stock_At_Hand, (case when Issued_By_National='0' then (@stock_out := @stock_out + Quantity) end) as total_stock_out, (case when Issued_To_National='0' then (@stock_in := @stock_in + Quantity) end) as total_stock_in, (@stock_balance := @stock_in - @stock_out) as total_stock_balance FROM Disbursements d where (Issued_By_National = '0' or Issued_To_National = '0')  and Vaccine_Id = '$vaccine' and Date_Issued_Timestamp between '$from' and '$to' order by $order_by $order) d") -> offset($offset) -> limit($items);
			}
		}
	...
	public static function getRegionalDisbursements($region, $vaccine, $from, $to, $offset, $items, $district_store = 0, $regional_store = 0, $order_by, $order, $balance = 0) {
		...
		if ($district_store > 0) {
			if ($order == "DESC") {
				$query -> addComponent('d', 'Disbursements') -> select('{d.Date_Issued},{d.Issued_To_National},{d.Issued_To_Region},{d.Issued_To_District},{d.Quantity},{d.Vaccine_Id},{d.Batch_Number},{d.Voucher_Number},{d.Added_By},{d.Stock_At_Hand},{d.Total_Stock_In},{d.Total_Stock_Out},{d.Total_Stock_Balance}') -> from("(SELECT id,Date_Issued,Issued_To_National,Issued_To_Region,Issued_To_District,Quantity,Vaccine_Id,Batch_Number,Voucher_Number,Added_By,Stock_At_Hand, (case when Issued_By_Region='$region' then (@stock_out := @stock_out - Quantity) end) as total_stock_out, (case when Issued_To_Region='$region'  then (@stock_in := @stock_in - Quantity) end) as total_stock_in, (@stock_balance := @stock_in - @stock_out) as total_stock_balance FROM Disbursements d where (Issued_By_Region = '$region' or Issued_To_Region = '$region')  and Vaccine_Id = '$vaccine' and Issued_To_District = '$district_store' and Date_Issued_Timestamp between '$from' and '$to' order by $order_by $order) d") -> offset($offset) -> limit($items);
			} else {
				$query -> addComponent('d', 'Disbursements') -> select('{d.Date_Issued},{d.Issued_To_National},{d.Issued_To_Region},{d.Issued_To_District},{d.Quantity},{d.Vaccine_Id},{d.Batch_Number},{d.Voucher_Number},{d.Added_By},{d.Stock_At_Hand},{d.Total_Stock_In},{d.Total_Stock_Out},{d.Total_Stock_Balance}') -> from("(SELECT id,Date_Issued,Issued_To_National,Issued_To_Region,Issued_To_District,Quantity,Vaccine_Id,Batch_Number,Voucher_Number,Added_By,Stock_At_Hand, (case when Issued_By_Region='$region' then (@stock_out := @stock_out + Quantity) end) as total_stock_out, (case when Issued_To_Region='$region'  then (@stock_in := @stock_in + Quantity) end) as total_stock_in, (@stock_balance := @stock_in - @stock_out) as total_stock_balance FROM Disbursements d where (Issued_By_Region = '$region' or Issued_To_Region = '$region')  and Vaccine_Id = '$vaccine' and Issued_To_District = '$district_store' and Date_Issued_Timestamp between '$from' and '$to' order by $order_by $order) d") -> offset($offset) -> limit($items);
			}
		} else if ($regional_store > 0) {
			if ($order == "DESC") {
				$query -> addComponent('d', 'Disbursements') -> select('{d.Date_Issued},{d.Issued_To_National},{d.Issued_To_Region},{d.Issued_To_District},{d.Quantity},{d.Vaccine_Id},{d.Batch_Number},{d.Voucher_Number},{d.Added_By},{d.Stock_At_Hand},{d.Total_Stock_In},{d.Total_Stock_Out},{d.Total_Stock_Balance}') -> from("(SELECT id,Date_Issued,Issued_To_National,Issued_To_Region,Issued_To_District,Quantity,Vaccine_Id,Batch_Number,Voucher_Number,Added_By,Stock_At_Hand, (case when Issued_By_Region='$region' then (@stock_out := @stock_out - Quantity) end) as total_stock_out, (case when Issued_To_Region='$region' then (@stock_in := @stock_in - Quantity) end) as total_stock_in, (@stock_balance := @stock_in - @stock_out) as total_stock_balance FROM Disbursements d where (Issued_By_Region = '$region' or Issued_To_Region = '$region')  and Vaccine_Id = '$vaccine' and Issued_To_Region = '$regional_store' and Date_Issued_Timestamp between '$from' and '$to' order by $order_by $order) d") -> offset($offset) -> limit($items);
			} else {
				$query -> addComponent('d', 'Disbursements') -> select('{d.Date_Issued},{d.Issued_To_National},{d.Issued_To_Region},{d.Issued_To_District},{d.Quantity},{d.Vaccine_Id},{d.Batch_Number},{d.Voucher_Number},{d.Added_By},{d.Stock_At_Hand},{d.Total_Stock_In},{d.Total_Stock_Out},{d.Total_Stock_Balance}') -> from("(SELECT id,Date_Issued,Issued_To_National,Issued_To_Region,Issued_To_District,Quantity,Vaccine_Id,Batch_Number,Voucher_Number,Added_By,Stock_At_Hand, (case when Issued_By_Region='$region' then (@stock_out := @stock_out + Quantity) end) as total_stock_out, (case when Issued_To_Region='$region' then (@stock_in := @stock_in + Quantity) end) as total_stock_in, (@stock_balance := @stock_in - @stock_out) as total_stock_balance FROM Disbursements d where (Issued_By_Region = '$region' or Issued_To_Region = '$region')  and Vaccine_Id = '$vaccine' and Issued_To_Region = '$regional_store' and Date_Issued_Timestamp between '$from' and '$to' order by $order_by $order) d") -> offset($offset) -> limit($items);
			}
		} else {
			...
			if ($order == "DESC") {
				$query -> addComponent('d', 'Disbursements') -> select('{d.Date_Issued},{d.Issued_To_National},{d.Issued_To_Region},{d.Issued_To_District},{d.Quantity},{d.Vaccine_Id},{d.Batch_Number},{d.Voucher_Number},{d.Added_By},{d.Stock_At_Hand},{d.Total_Stock_In},{d.Total_Stock_Out},{d.Total_Stock_Balance}') -> from("(SELECT id,Date_Issued,Issued_To_National,Issued_To_Region,Issued_To_District,Quantity,Vaccine_Id,Batch_Number,Voucher_Number,Added_By,Stock_At_Hand, (case when Issued_By_Region='$region' then (@stock_out := @stock_out - Quantity) end) as total_stock_out, (case when Issued_To_Region='$region' then (@stock_in := @stock_in - Quantity) end) as total_stock_in, (@stock_balance := @stock_in - @stock_out) as total_stock_balance FROM Disbursements d where (Issued_By_Region = '$region' or Issued_To_Region = '$region')  and Vaccine_Id = '$vaccine' and Date_Issued_Timestamp between '$from' and '$to' order by $order_by $order) d") -> offset($offset) -> limit($items);
			} else {
				$query -> addComponent('d', 'Disbursements') -> select('{d.Date_Issued},{d.Issued_To_National},{d.Issued_To_Region},{d.Issued_To_District},{d.Quantity},{d.Vaccine_Id},{d.Batch_Number},{d.Voucher_Number},{d.Added_By},{d.Stock_At_Hand},{d.Total_Stock_In},{d.Total_Stock_Out},{d.Total_Stock_Balance}') -> from("(SELECT id,Date_Issued,Issued_To_National,Issued_To_Region,Issued_To_District,Quantity,Vaccine_Id,Batch_Number,Voucher_Number,Added_By,Stock_At_Hand, (case when Issued_By_Region='$region' then (@stock_out := @stock_out + Quantity) end) as total_stock_out, (case when Issued_To_Region='$region' then (@stock_in := @stock_in + Quantity) end) as total_stock_in, (@stock_balance := @stock_in - @stock_out) as total_stock_balance FROM Disbursements d where (Issued_By_Region = '$region' or Issued_To_Region = '$region')  and Vaccine_Id = '$vaccine' and Date_Issued_Timestamp between '$from' and '$to' order by $order_by $order) d") -> offset($offset) -> limit($items);
			}
		}
	...
	public static function getDistrictDisbursements($district, $vaccine, $from, $to, $offset, $items, $order_by, $order, $district_store = 0,$balance = 0) {
		...
		if ($district_store > 0) {
			if ($order == "DESC") {
				$query -> addComponent('d', 'Disbursements') -> select('{d.Date_Issued},{d.Issued_To_National},{d.Issued_To_Region},{d.Issued_To_District},{d.Quantity},{d.Vaccine_Id},{d.Batch_Number},{d.Voucher_Number},{d.Added_By},{d.Stock_At_Hand},{d.Total_Stock_In},{d.Total_Stock_Out},{d.Total_Stock_Balance}') -> from("(SELECT id,Date_Issued,Issued_To_National,Issued_To_Region,Issued_To_District,Quantity,Vaccine_Id,Batch_Number,Voucher_Number,Added_By,Stock_At_Hand, (case when Issued_By_District='$district' then (@stock_out := @stock_out - Quantity) end) as total_stock_out, (case when Issued_To_District='$district' then (@stock_in := @stock_in - Quantity) end) as total_stock_in, (@stock_balance := @stock_in - @stock_out) as total_stock_balance FROM Disbursements d where (Issued_By_District = '$district' or Issued_To_District = '$district')  and Vaccine_Id = '$vaccine' and Issued_To_District = '$district_store' and Date_Issued_Timestamp between '$from' and '$to' order by $order_by $order) d") -> offset($offset) -> limit($items);
			} else {
				$query -> addComponent('d', 'Disbursements') -> select('{d.Date_Issued},{d.Issued_To_National},{d.Issued_To_Region},{d.Issued_To_District},{d.Quantity},{d.Vaccine_Id},{d.Batch_Number},{d.Voucher_Number},{d.Added_By},{d.Stock_At_Hand},{d.Total_Stock_In},{d.Total_Stock_Out},{d.Total_Stock_Balance}') -> from("(SELECT id,Date_Issued,Issued_To_National,Issued_To_Region,Issued_To_District,Quantity,Vaccine_Id,Batch_Number,Voucher_Number,Added_By,Stock_At_Hand, (case when Issued_By_District='$district' then (@stock_out := @stock_out + Quantity) end) as total_stock_out, (case when Issued_To_District='$district' then (@stock_in := @stock_in + Quantity) end) as total_stock_in, (@stock_balance := @stock_in - @stock_out) as total_stock_balance FROM Disbursements d where (Issued_By_District = '$district' or Issued_To_District = '$district')  and Vaccine_Id = '$vaccine' and Issued_To_District = '$district_store' and Date_Issued_Timestamp between '$from' and '$to' order by $order_by $order) d") -> offset($offset) -> limit($items);
			}
		} else {
			...
			if ($order == "DESC") {
				$query -> addComponent('d', 'Disbursements') -> select('{d.Date_Issued},{d.Issued_To_National},{d.Issued_To_Region},{d.Issued_To_District},{d.Quantity},{d.Vaccine_Id},{d.Batch_Number},{d.Voucher_Number},{d.Added_By},{d.Stock_At_Hand},{d.Total_Stock_In},{d.Total_Stock_Out},{d.Total_Stock_Balance}') -> from("(SELECT id,Date_Issued,Issued_To_National,Issued_To_Region,Issued_To_District,Quantity,Vaccine_Id,Batch_Number,Voucher_Number,Added_By,Stock_At_Hand, (case when Issued_By_District='$district' then (@stock_out := @stock_out - Quantity) end) as total_stock_out, (case when Issued_To_District='$district' then (@stock_in := @stock_in - Quantity) end) as total_stock_in, (@stock_balance := @stock_in - @stock_out) as total_stock_balance FROM Disbursements d where (Issued_By_District = '$district' or Issued_To_District = '$district')  and Vaccine_Id = '$vaccine' and Date_Issued_Timestamp between '$from' and '$to' order by $order_by $order) d") -> offset($offset) -> limit($items);
			} else {
				$query -> addComponent('d', 'Disbursements') -> select('{d.Date_Issued},{d.Issued_To_National},{d.Issued_To_Region},{d.Issued_To_District},{d.Quantity},{d.Vaccine_Id},{d.Batch_Number},{d.Voucher_Number},{d.Added_By},{d.Stock_At_Hand},{d.Total_Stock_In},{d.Total_Stock_Out},{d.Total_Stock_Balance}') -> from("(SELECT id,Date_Issued,Issued_To_National,Issued_To_Region,Issued_To_District,Quantity,Vaccine_Id,Batch_Number,Voucher_Number,Added_By,Stock_At_Hand, (case when Issued_By_District='$district' then (@stock_out := @stock_out + Quantity) end) as total_stock_out, (case when Issued_To_District='$district' then (@stock_in := @stock_in + Quantity) end) as total_stock_in, (@stock_balance := @stock_in - @stock_out) as total_stock_balance FROM Disbursements d where (Issued_By_District = '$district' or Issued_To_District = '$district')  and Vaccine_Id = '$vaccine' and Date_Issued_Timestamp between '$from' and '$to' order by $order_by $order) d") -> offset($offset) -> limit($items);
			}
		}
	...
	public static function getNationalReceived($vaccine, $from, $to) {
		$query = Doctrine_Query::create() -> select("Date_Issued,Issued_To_Region,Issued_To_District,Quantity,Vaccine_Id,Batch_Number,Voucher_Number,Added_By") -> from("Disbursements") -> where("Issued_To_National = '0' and Vaccine_Id = '$vaccine' and Date_Issued_Timestamp between '$from' and '$to'") -> orderBy("Date_Issued_Timestamp desc");
		$disbursements = $query -> execute();
		return $disbursements;
	}
	...
	public static function getNationalPeriodBalance($vaccine, $from) {
		$query = Doctrine_Query::create() -> select("SUM(Quantity) as Totals") -> from("Disbursements") -> where("Issued_By_National = '0' and Vaccine_Id = '$vaccine' and Date_Issued_Timestamp < '$from'");
		$issued = $query -> execute(array(), Doctrine::HYDRATE_ARRAY);
		$query2 = Doctrine_Query::create() -> select("SUM(Quantity) as Totals") -> from("Disbursements") -> where("Issued_To_National = '0' and Vaccine_Id = '$vaccine' and Date_Issued_Timestamp < '$from'");
